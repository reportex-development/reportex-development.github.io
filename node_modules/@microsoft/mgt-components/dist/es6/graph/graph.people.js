 ...
 */
export function findPeople(graph, query, top = 10, userType = UserType.any) {
 ...
 * @memberof Graph
 */
export function getPeople(graph, userType = UserType.any) {
    return __awaiter(this, void 0, void 0, function* () {
        const scopes = 'people.read';
        let cache;
        ...
        let people;
        try {
            people = yield graph.api(uri).middlewareOptions(prepScopes(scopes)).filter(filter).get();
