 ...
 */
let MgtPersonCardProfile = class MgtPersonCardProfile extends BasePersonCardSection {
    constructor(profile) {
        super();
        ...
        for (const position of this._profile.positions) {
          ...
          <div class="data-list__item work-position">
            <div class="data-list__item__header">
              <div class="data-list__item__title">${(_a = position.detail) === null || _a === void 0 ? void 0 : _a.jobTitle}</div>
